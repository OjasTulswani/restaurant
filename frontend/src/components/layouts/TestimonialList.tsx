    ...
    <div>
      <div className="flex flex-nowrap overflow-x-auto scrollbar-hidden gap-8 ">
        {testimonials.map((testimonial, index) => (
          <div
            key={index}
            className="p-4 border rounded text-gray-600 bg-slate-50 hover:bg-white focus:outline-none focus:ring-4 focus:ring-gray-50 font-medium text-xs rounded-tl-2xl rounded-br-2xl  px-5 py-2.5 text-center me-2 mb-2 h-34 w-56 "
          >
